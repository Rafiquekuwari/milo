...
import NumberLineExplorer from '@/components/teen/sims/NumberLineExplorer'
import IntegersTeenLesson, { makeRound, IntegerWatch, type Round } from '@/components/lessons/IntegersTeenLesson'
...
export default function IntegersChapter(_props: Props) {
  ...
  const finish = useCallback((c: number, w: number) => {
    ...
    finishAndSync('integers', c, w, 'practice')
  }, [finishAndSync])
