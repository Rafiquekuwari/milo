...
import ExpressionEvaluator from '@/components/teen/sims/ExpressionEvaluator'
import AlgebraicExpressionsTeenLesson, { makeRound, ExprWatch, fmtInt, type Round } from '@/components/lessons/AlgebraicExpressionsTeenLesson'
...
export default function AlgebraicExpressionsChapter(_props: Props) {
  ...
  const finish = useCallback((c: number, w: number) => {
    ...
    finishAndSync('algebraicExpressions', c, w, 'practice')
  }, [finishAndSync])
