...
import PythagorasExplorer from '@/components/teen/sims/PythagorasExplorer'
import RadicalsPythagoreanTeenLesson, {
  makeRound, isCorrect, RadicalWatch, type Round,
} from '@/components/lessons/RadicalsPythagoreanTeenLesson'
...
export default function RadicalsPythagoreanChapter(_props: Props) {
  ...
  const finish = useCallback((c: number, w: number) => {
    ...
    finishAndSync('radicalsPythagorean', c, w, 'practice')
  }, [finishAndSync])
