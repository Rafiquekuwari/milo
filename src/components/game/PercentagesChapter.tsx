...
import PercentBarExplorer from '@/components/teen/sims/PercentBarExplorer'
import PercentagesTeenLesson, { makeRound, PercentWatch, tidy, type Round } from '@/components/lessons/PercentagesTeenLesson'
...
export default function PercentagesChapter(_props: Props) {
  ...
  const finish = useCallback((c: number, w: number) => {
    ...
    finishAndSync('percentages', c, w, 'practice')
  }, [finishAndSync])
