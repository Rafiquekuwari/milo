...
import RatioExplorer from '@/components/teen/sims/RatioExplorer'
...
import RatioProportionTeenLesson, { makeRound, RatioWatch, type Round } from '@/components/lessons/RatioProportionTeenLesson'
...
export default function RatioProportionChapter(_props: Props) {
  ...
  const finish = useCallback((c: number, w: number) => {
    ...
    finishAndSync('ratioProportion', c, w, 'practice')
  }, [finishAndSync])
