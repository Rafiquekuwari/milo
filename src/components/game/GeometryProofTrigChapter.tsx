...
import TrigTriangleExplorer from '@/components/teen/sims/TrigTriangleExplorer'
import GeometryProofTrigTeenLesson, {
  makeRound, ProofWatch, type Round,
} from '@/components/lessons/GeometryProofTrigTeenLesson'
...
export default function GeometryProofTrigChapter(_props: Props) {
  ...
  const finish = useCallback((c: number, w: number) => {
    ...
    finishAndSync('geometryProofTrig', c, w, 'practice')
  }, [finishAndSync])
