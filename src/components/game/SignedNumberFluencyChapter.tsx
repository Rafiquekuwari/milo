...
import type { ChapterType } from '@/lib/chapters'
...
import SignedJumpExplorer from '@/components/teen/sims/SignedJumpExplorer'
import SignedNumberFluencyTeenLesson, {
  makeRound, SignedWatch, ChainWatch, type Round,
} from '@/components/lessons/SignedNumberFluencyTeenLesson'
...
export default function SignedNumberFluencyChapter(_props: Props) {
  ...
  const finish = useCallback((c: number, w: number) => {
    ...
    finishAndSync(SKILL, c, w, 'practice')
  }, [finishAndSync])
